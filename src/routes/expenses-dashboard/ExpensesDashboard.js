        ...
        <main className="expenses-dashboard">
            <article>
                <section className="expenses-action-btns">
                    <button className='dash-button' onClick={toggleExpenseModal}>Gider ekle &#65291;</button>
                    <button className='dash-button'  onClick={toggleIncomeModal}>Gelir ekle &#65291;</button>
                </section>
            </article>
            <article className='expenses-grid'>
                <section className='expenses-tabs'>
                    <button onClick={setExpenseTab} className={`${expenseTable ? 'active-tab' : null}`}>Giderler</button>
                    <button onClick={setIncomeTab} className={`${expenseTable ? null : 'active-tab'}`}>Gelirler</button>
                </section>
                {expenseTable ?
                    <>
